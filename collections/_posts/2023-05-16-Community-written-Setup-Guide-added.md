...
"Ohcee" (Github name) received bounty for a new <a href="{{ site.baseurl }}/uploads/setup_guides/Veil-wallet-install-Linux-GUI.html">Ubuntu GUI SETUP GUIDE for the Veil core wallet</a>. 2023-05-16 This is also linked from the [Wallet download / Get Started page]({{ site.baseurl }}/get-started/).
