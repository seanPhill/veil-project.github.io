...
**Important** — While all wallet issues are canonically tracked in GitHub Issues are of our repository, there is a condensed list of the most important issues new users should be aware of in our [Changelog document]({{ site.baseurl }}/changelog/). Be sure to review this list before downloading and installing the wallet.
